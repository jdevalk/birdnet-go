...
func (c *Handler) processHourlyBatchSpecies(ctx echo.Context, speciesParams []string, date string, sourceIDs []uint, ip, path string) (results map[string][]HourlyDistribution, processingErrors []string) {
