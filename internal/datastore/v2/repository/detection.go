...
type DetectionRepository interface {
	...
	// sourceIDs is variadic; omit to include all audio sources.
	GetHourlyDistribution(ctx context.Context, start, end int64, tzOffsetSeconds int, labelIDs []uint, modelID *uint, sourceIDs ...uint) ([]HourlyDistributionData, error)
	...
	// sourceIDs is variadic; omit to include all audio sources.
	GetDailyAnalytics(ctx context.Context, start, end int64, tzOffsetSeconds int, labelIDs []uint, modelID *uint, sourceIDs ...uint) ([]DailyAnalyticsData, error)
